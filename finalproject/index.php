...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      <div class="vid-parent">
        ...
        <img src="image/background.jpg" alt="hi" width="100%" height="100%">
        <div class="vid-overlay"></div>
      </div>
      <div class="vid-content" >
        <h1 class="my-content">Welcome to LMSHA Academy</h1>
            ...
            <a href="coursedetails.php?course_id='.$course_id.'" class="btn" style="text-align: left; padding:0px; margin:0px;">
              <div class="card">
                ...
                <div class="card-footer">
                  <p class="card-text d-inline">Price: <small><del>RS '.$row['course_original_price'].'</del></small> <span class="font-weight-bolder">RS '.$row['course_price'].'<span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="coursedetails.php?course_id='.$course_id.'">Enroll</a>
                </div>
              </div>
            </a>  ';
          }
              ...
              echo '
                <a href="coursedetails.php?course_id='.$course_id.'"  class="btn" style="text-align: left; padding:0px;">
                  <div class="card">
                    ...
                    <div class="card-footer">
                      <p class="card-text d-inline">Price: <small><del>RS '.$row['course_original_price'].'</del></small> <span class="font-weight-bolder">RS '.$row['course_price'].'<span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="#">Enroll</a>
                    </div>
                  </div>
                </a>  ';
            }
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>LMSHA TECH PROVIDE Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe impedit quidem ratione vitae minus, dolorem voluptates culpa! Ipsum, inventore illum?
              </p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>LMSHA <br> Near ABDULLAH hospital <br> Lorem, ipsum dolor. <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
