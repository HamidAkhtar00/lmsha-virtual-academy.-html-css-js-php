...
<html lang="en">
  <head>
    ...
    <title>lmsha tech</title>
  </head>
  <body>
     <!-- Start Nagigation -->
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand"><img src="image/logo1.png" alt="LMSHA ACADEMY" height="110px" ></a>
      <span class="navbar-text">LMSHA Academy</span>
